...
<head>
    <style>
        body {
            background: url('assets/img/bg.jpg') center center fixed;
  ...
  initial-scale=1.0">
    ...
    <title>Coffe Ecommerce</title>
    <link rel="icon" type="image/x-icon" href="assets/img/coffe.png" />
        ...
        <div class="container-fluid">
            <div class="me-5">
                <a class="navbar-brand" href="{{route('dashboard')}}">
                    <img src="/assets/img/coffe.png" alt="Logo" width="60" height="60" class="d-inline-block align-text-top">
                    <b class="fs-3">Coffe Ecommerce</b>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-5 me-auto mb-2 mb-lg-0">
                    @if(Auth::user()->role == 'masteradmin' || Auth::user()->role == 'Masteradmin')
                        <li class="nav-item">
